...
function getHeaderFromHeaders(headers: any, headerName: string) {
...
function loadScript(url: string, onLoadCallback: any) {
...
export function _GSPS2PDF(
  ...
  xhr.onload = function () {
    ...
    Module = {
      ...
      postRun: [
        function () {
          var uarray = fs.readFile("DavidMurdochCV.pdf", {
            encoding: "binary",
          }); //Uint8Array
      ...
      arguments: [
        ...
        "-dQUIET",
        "-dBATCH",
        "-sOutputFile=DavidMurdochCV.pdf",
        "input.pdf",
      ],
